...
public class Test_Users {
    ...
    public static void main(String[] args) {
        ...
        while (continuar != 4) {
            ...
            String[] vec1 = {SingletonF.language.getProperty("create"), SingletonF.language.getProperty("change_data"),
                SingletonF.language.getProperty("print_data"), SingletonF.language.getProperty("delete"),
                SingletonF.language.getProperty("find"), SingletonF.language.getProperty("sortby"),
                SingletonF.language.getProperty("export"), SingletonF.language.getProperty("import"),
            ...
            String[] config = {SingletonF.language.getProperty("date"), SingletonF.language.getProperty("currency"),
                SingletonF.language.getProperty("decimals"), SingletonF.language.getProperty("lang"),
                SingletonF.language.getProperty("savingextension"), SingletonF.language.getProperty("looknfeel"),
                SingletonF.language.getProperty("resetconf"), "DUMMIES", SingletonF.language.getProperty("go_back"),
                SingletonF.language.getProperty("exit")};
            String[] dateconfig = {"dd/mm/yyyy", "dd-mm-yyyy", "yyyy/mm/dd", "yyyy-mm-dd",
                SingletonF.language.getProperty("go_back"), SingletonF.language.getProperty("exit")};
            String[] currencyconfig = {"Euro \u20ac", "Dollar $", "Libra £", SingletonF.language.getProperty("go_back"),
                SingletonF.language.getProperty("exit")};
            String[] languageconfig = {SingletonF.language.getProperty("english"),
                SingletonF.language.getProperty("spanish"), SingletonF.language.getProperty("go_back"),
                SingletonF.language.getProperty("exit")};
            String[] decimalsconfig = {SingletonF.language.getProperty("1decimal"),
                SingletonF.language.getProperty("2decimal"), SingletonF.language.getProperty("3decimal"),
                SingletonF.language.getProperty("go_back"), SingletonF.language.getProperty("exit")};
            String[] save = {SingletonF.language.getProperty("savejson"), SingletonF.language.getProperty("savexml"),
                SingletonF.language.getProperty("savetxt"), SingletonF.language.getProperty("go_back")};
            String[] looknfeel = {"Metal", "GTK Windows", "CDE/Motif", "Nimbus", SingletonF.language.getProperty("go_back")};
            String[] dummies = {SingletonF.language.getProperty("dummieson"), SingletonF.language.getProperty("dummiesoff"),
            ...
            switch (option) {
                    ...
                    do {
                        ...
                        switch (option) {
                            ...
                            case 5://Sort by
                                ...
                                option = Menus.menu(sortBy, SingletonF.language.getProperty("sortadmins"),
                ...
                case 1://Clients
                    do {
                        continuar2 = true;
                        option = Menus.menu(vec1, SingletonF.language.getProperty("client"),
                                SingletonF.language.getProperty("application_users"));
                        switch (option) {
                            case 0:
                ...
                case 2://Registered_users
                    do {
                        continuar2 = true;
                        option = Menus.menu(vec1, SingletonF.language.getProperty("registered_user"),
                                SingletonF.language.getProperty("application_users"));
                        switch (option) {
                            case 0://Add data
                ...
                case 3:
                    do {
                        ...
                        option = Menus.menu(config, SingletonF.language.getProperty("config2")
                                ...
                                + SingletonF.configApp.getDate_config() + "     " + 
                                SingletonF.language.getProperty("currency2") + SingletonF.configApp.getCurrency_config()
                                + "     " + SingletonF.language.getProperty("decimals2") + 
                                SingletonF.configApp.getDecimals_config() + "     " + 
                                SingletonF.language.getProperty("language") + SingletonF.configApp.getLanguage_config(),
                                SingletonF.language.getProperty("config"));
                        switch (option) {
                            case 0://date format
                                option = Menus.menu(dateconfig, SingletonF.language.getProperty("dateconf2"),
                                        SingletonF.language.getProperty("dateconf"));
                                switch (option) {
                                    case 0:// dd/mm/yyyy
                            ...
                            case 1://Currency format
                                option = Menus.menu(currencyconfig, SingletonF.language.getProperty("currencyconf2"),
                                        SingletonF.language.getProperty("currencyconf"));
                                switch (option) {
                                    case 0:
                                ...
                                break;
                            case 2://Decimals
                                option = Menus.menu(decimalsconfig, SingletonF.language.getProperty("decimalsconf2"),
                                        SingletonF.language.getProperty("decimalsconf"));
                                switch (option) {
                                    case 0:
                                ...
                                break;
                            case 3://Language
                                option = Menus.menu(languageconfig, SingletonF.language.getProperty("dateconf"),
                                        SingletonF.language.getProperty("dateconf2"));
                                switch (option) {
                                    case 0:
                            ...
                            case 4://Saving extension
                                option = Menus.menu(save, SingletonF.language.getProperty("saveadmins"),
                                        SingletonF.language.getProperty("save"));
                                switch (option) {
                                    case 0://json
                            ...
                            case 5://Look and feel
                                option = Menus.menu(looknfeel, SingletonF.language.getProperty("looknfeel"),
                                        SingletonF.language.getProperty("themes"));
                                switch (option) {
                                    case 0://Metal
                            ...
                            case 6://Resets the default configuration
                                ...
                                break;
                            case 7://DUMMIES
                                option = Menus.menu(dummies, SingletonF.language.getProperty("admin"),
                                        SingletonF.language.getProperty("application_users"));
                                switch (option) {
